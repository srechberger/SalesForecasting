...
# Store 708:  {'max_depth': 8, 'min_samples_leaf': 5, 'min_samples_split': 10, 'n_estimators': 10}

# Fit Model Store 708
rf_model_708_gs = RandomForestRegressor(n_estimators=10, max_depth=8, min_samples_split=10, min_samples_leaf=5)
...
# Store 198:  {'max_depth': 5, 'min_samples_leaf': 2, 'min_samples_split': 2, 'n_estimators': 20}

# Fit Model Store 198
rf_model_198_gs = RandomForestRegressor(n_estimators=20, max_depth=5, min_samples_split=2, min_samples_leaf=2)
...
# Store 897:  {'max_depth': 10, 'min_samples_leaf': 8, 'min_samples_split': 10, 'n_estimators': 15}

# Fit Model Store 897
rf_model_897_gs = RandomForestRegressor(n_estimators=15, max_depth=10, min_samples_split=10, min_samples_leaf=8)
