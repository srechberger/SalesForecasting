...
with open('../../../data/kaggleTutorials/input/PoliceKillingsUS.csv', 'rb') as rawdata:
...
police_killings = pd.read_csv('../../../data/kaggleTutorials/input/PoliceKillingsUS.csv', encoding='Windows-1252')
