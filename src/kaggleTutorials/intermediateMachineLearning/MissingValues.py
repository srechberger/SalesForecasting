...
# 2) A Better Option:
#       Imputation (Imputation fills in the missing values with some number.
...
# Load the data
data = pd.read_csv('../../../data/kaggleTutorials/input/melb_data.csv')
...
##############################################################################
################# 01 Drop columns with missing values ########################
##############################################################################
