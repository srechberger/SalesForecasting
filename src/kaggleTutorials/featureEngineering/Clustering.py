...
df = pd.read_csv("../../../data/kaggleTutorials/input/housing.csv.zip")
...
path = "../../../data/kaggleTutorials/output/figures/cluster1.png"
...
path = "../../../data/kaggleTutorials/output/figures/cluster2.png"
