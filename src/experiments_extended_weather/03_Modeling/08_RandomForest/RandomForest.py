...
# Get Training Data
# All Stores
X_train = pd.read_pickle('../../../../data/rossmann/intermediate/06_SalesModelingExtendedWeather/01_AllStores/train_X.pkl')
y_train = pd.read_pickle('../../../../data/rossmann/intermediate/06_SalesModelingExtendedWeather/01_AllStores/train_y.pkl')
# Store 708
...
# Store 708:  {'max_depth': 10, 'min_samples_leaf': 8, 'min_samples_split': 5, 'n_estimators': 10}

# Fit Model Store 708
rf_model_708_gs = RandomForestRegressor(n_estimators=10, max_depth=10, min_samples_split=5, min_samples_leaf=8)
...
# Store 198:  {'max_depth': 8, 'min_samples_leaf': 2, 'min_samples_split': 10, 'n_estimators': 30}

# Fit Model Store 198
rf_model_198_gs = RandomForestRegressor(n_estimators=30, max_depth=8, min_samples_split=10, min_samples_leaf=2)
...
# Store 897:  {'max_depth': 10, 'min_samples_leaf': 8, 'min_samples_split': 10, 'n_estimators': 10}

# Fit Model Store 897
rf_model_897_gs = RandomForestRegressor(n_estimators=10, max_depth=10, min_samples_split=10, min_samples_leaf=8)
