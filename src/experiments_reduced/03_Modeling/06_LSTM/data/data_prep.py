...
sales_708 = pd.read_pickle(
    '../../../../../data/rossmann/intermediate/04_SalesModelingReduced/02_Store708/sales708.pkl')
sales_198 = pd.read_pickle(
    '../../../../../data/rossmann/intermediate/04_SalesModelingReduced/03_Store198/sales198.pkl')
sales_897 = pd.read_pickle(
    '../../../../../data/rossmann/intermediate/04_SalesModelingReduced/04_Store897/sales897.pkl')
