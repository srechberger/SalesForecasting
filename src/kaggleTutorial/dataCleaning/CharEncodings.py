...
with open("../../../data/kickstarter/input/ks-projects-201612.csv.zip", 'rb') as rawdata:
...
kickstarter_2016 = pd.read_csv("../../../data/kickstarter/input/ks-projects-201612.csv.zip", encoding='Windows-1252')
